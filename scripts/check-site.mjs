...
for (const readerBehavior of ["IntersectionObserver", "search-index.json", "reader-menu", "localStorage"]) assert.ok(bookJs.includes(readerBehavior), `Missing reader interaction: ${readerBehavior}`);
